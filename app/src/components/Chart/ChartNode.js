    ...
    <li className={"oc-hierarchy level-" + level}>
      ...
      >
        ...
        <div className="oc-container">
          ...
          {(ds.departments || ds.person || ds.contact || ds.address) && (
                    ...
                    <li key={i + ds.name + "-" + department.name}>
                      ...
                      {department.employees && (
                        <ul className="employees">
                          {department.employees &&
                            department.employees.map((employee, j) => (
                              <li
